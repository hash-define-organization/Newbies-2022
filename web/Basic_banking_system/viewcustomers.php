     ...
     <div class="navbar navbar-expand-md">
      ...
      <span class="navbar-toggler-icon" style="background:white;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          ...
          $selectquery = " select id,name, email, amount from users1";
           ...
           while($res = mysqli_fetch_assoc($query))
          {
            ?>
              ...
              <td><a href="transfermoney.php?idtransfer=<?php echo $res['id']; ?>" ><i class=" fa fa-user-circle large" aria-hidden="true" style="color:#04FB73;"></i></a></td><!--aria-hidden for hiding non interactive element-->
               </tr>
             <?php
          }
           ?>
